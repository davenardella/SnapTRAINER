...
begin
  ...
  try
    ...
    ini.WriteBool(CommSection,'BaseAddressZero',CommSettings.BaseAddressZero);
    // Modbus/TCP
...
Var
  ...
  begin
    ...
    CommSettings.BaseAddressZero:=ini.ReadBool(CommSection,'BaseAddressZero',CommSettings.BaseAddressZero);
    // Modbus/TCP
